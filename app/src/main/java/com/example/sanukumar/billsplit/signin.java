...
public class signin extends AppCompatActivity {
    ...
    private void updateUI(FirebaseUser currentUser) {
        ...
        startActivity(new Intent(signin.this, HomeScreenActivityActivity.class));
        finish();
    }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent i=new Intent(signin.this,HomeScreenActivityActivity.class);
                            startActivity(i);
                            finish();
                            NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(signin.this, "default")
                            ...
                            NotificationManagerCompat notificationManagerCompat = NotificationManagerCompat.from(signin.this);
